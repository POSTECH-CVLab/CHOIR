...
class VNTLinear(nn.Module):
    def __init__(self, in_channels, out_channels, which_norm_VNT='norm'): # norm is default: https://github.com/orenkatzir/VN-SPD/blob/master/options/base_options.py
...
class VNTLinearLeakyReLU(nn.Module):
    def __init__(self, in_channels, out_channels, dim=5, share_nonlinearity=False, negative_slope=0.2, use_batchnorm=True, which_norm_VNT='norm'):
...
class VNTMaxPool(nn.Module):
    def __init__(self, in_channels, which_norm_VNT='norm'):
...
class VNTStdFeature(nn.Module):
    def __init__(self, in_channels, dim=4, normalize_frame=False, share_nonlinearity=False, negative_slope=0.2, use_batchnorm=True, which_norm_VNT='norm'):
