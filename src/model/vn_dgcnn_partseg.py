...
from src.model.vnn_modules.vn_dgcnn_util import get_graph_feature


class get_model(nn.Module):
    def __init__(self, args, num_cat=16, num_part=50, normal_channel=False):
        ...
        self.conv7 = nn.Sequential(nn.Conv1d(num_cat, 64, kernel_size=1, bias=False),
                                   self.bn7,
                                   nn.LeakyReLU(negative_slope=0.2))
