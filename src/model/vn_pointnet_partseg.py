...
from src.model.vnn_modules.vn_layers import *
from src.model.vnn_modules.vn_pointnet import STNkd
from src.model.vnn_modules.vn_dgcnn_util import get_graph_feature_cross


class get_model(nn.Module):
    def __init__(self, args, num_cat=16, num_part=50, normal_channel=True):
        ...
        self.convs1 = torch.nn.Conv1d(9009 + num_cat, 256, 1)
    ...
    def forward(self, point_cloud, label):
        ...
        expand = out_max.view(-1, 2048//3*6+self.num_cat, 1).repeat(1, 1, N)
